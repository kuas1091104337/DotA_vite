...
@media screen and (min-width: 400px) {
  .lottoMachine_nav_item{width: calc(33.3333% - 20px);}
}
...
@media screen and (min-width: 1024px) {
  .lottoMachine{
    &_title{margin: .75em auto}
    &_wrap{margin:7.5% auto;}
    &_nav{
...
@media screen and (min-width: 1280px) {
  .lottoMachine{
    &_title{
      font-size:90px;
      text-shadow:-2px -2px 0 rgba(0,232,231,1),
                  -4px -4px 2px rgba(0,232,231,.6),
                  2px 2px 0 rgba(250,126,39,1),
                  4px 4px 2px rgba(250,126,39,.6),
                  0 0 8px #000,
                  0 0 12px #000,
                  0 0 16px #000;
      margin:25px auto 0;
...
@media screen and (min-width: 1920px) {
  .lottoMachine_wrap{padding-bottom:540px;}
}
</style>