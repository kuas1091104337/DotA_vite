...
.en-US, .th-TH, .vi-VN{
  .q8Unit__contentBox__item_text{margin-left:0;}
}
.zh-TW, .zh-CN{
  .q8Unit__contentBox_title2{text-indent:26px;}
}
.th-TH{
...
@media screen and (min-width:1600px){
  .q8Unit{
    &__imgBox{flex-basis:55%;}
    &__contentBox{flex-basis:45%;}
  }
  .q8About, .q8Lottery{background-size:initial;}
}
@media screen and (min-width:2100px){
  .q8Head, .q8Home, .q8Unit, .q8Process, .q8Contact, .q8Foot{
    max-width:2100px;
    margin:0 auto;
    box-shadow:300px 0 0 $q8BgRed, -300px 0 0 $q8BgRed;
  }
}
</style>