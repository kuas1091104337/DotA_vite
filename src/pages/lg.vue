...
const newsSlideTime = 3500,
      ...
      newsSlide = () => {
        if(lgNews.idx < lgNewsData.value.length){
          ...
          animateScrollTo(lgNews.height*lgNews.idx,{elementToScroll:lgNewsWrap.value});
        }else{
          lgNews.idx = 0;
...
@keyframes lgMainBall{
  0% {transform:rotate3d(0, 0, 0, 0deg) translate3d(10px, -10px, -100px);}
  5% {transform:rotate3d(0.5, 0.5, 1, 30deg) translate3d(20px, 0px, -50px);}
  10% {transform:rotate3d(0, 0, 1, 60deg) translate3d(5px, 15px, 0px);}
  15% {transform:rotate3d(0, 0.3, 1, 85deg) translate3d(10px, 20px, 50px);}
  20% {transform:rotate3d(0, 0, 1, 110deg) translate3d(20px, 25px, 100px);}
  25% {transform:rotate3d(0.2, 0, 1, 135deg) translate3d(30px, 15px, 150px);}
  30% {transform:rotate3d(0, 0, 1, 160deg) translate3d(40px, 20px, 200px);}
  35% {transform:rotate3d(0, 0, 1, 180deg) translate3d(25px, 30px, 240px);}
  40% {transform:rotate3d(0, 0.1, 1, 200deg) translate3d(25px, 15px, 280px);}
  45% {transform:rotate3d(0, 0, 1, 220deg) translate3d(10px, 10px, 320px);}
  50% {transform:rotate3d(0.1, 0.1, 1, 240deg) translate3d(5px, 20px, 360px);}
  55% {transform:rotate3d(0, 0, 1, 260deg) translate3d(5px, 10px, 400px);}
  60% {
      transform:rotate3d(0, 0.1, 1, 275deg) translate3d(-5px, 5px, 430px);
      opacity:1;
  }
  65% {
      transform:rotate3d(0, 0, 1, 290deg) translate3d(-10px, 10px, 460px);
      opacity:.8;
  }
  70% {
      transform:rotate3d(0.1, 0, 1, 305deg) translate3d(-15px, 15px, 490px);
      opacity:.6;
  }
  75% {
      transform:rotate3d(0, 0, 1, 320deg) translate3d(-5px, 25px, 520px);
      opacity:.8;
  }
  80% {
      transform:rotate3d(0.1, 0.1, 1, 330deg) translate3d(-5px, 15px, 540px);
      opacity:1;
  }
  85% {transform:rotate3d(0, 0, 1, 340deg) translate3d(-15px, 5px, 560px);}
  90% {transform:rotate3d(0.1, 0, 1, 350deg) translate3d(-20px, 10px, 580px);}
  95% {transform:rotate3d(0, 0, 1, 355deg) translate3d(-30px, -15px, 590px);}
  100% {transform:rotate3d(0, 0.1, 1, 360deg) translate3d(-15px, -10px, 600px);}
}
