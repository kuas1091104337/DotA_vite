...
@media screen and (max-width: 320px){
  .vi-VN .q8Head__menu__link{font-size:21px;}
}
// ===== 桌機版型區 =====
@media screen and (min-width: 1024px){
  .zh-TW, .zh-CN{
    .q8Head__menu__link{padding:0 12px;}
  }
  .en-US, .th-TH, .vi-VN{
    .q8Head__menu__link{padding:0 8px;}
  }
  .vi-VN ,.th-TH{
    .q8Head__menu{
      &_item_select, &__link{font-size:13px;}
    }
  }
  .q8Head{
...
@media screen and (min-width: 1200px){
  ...
  .en-US .q8Head__menu__link{padding:0 12px;}
  .th-TH  .q8Head__menu__link{padding:0 10px;}
  .vi-VN .q8Head__menu__link{
    font-size:13px;
    padding:0 10px;
  }
}
